defmodule SSHKit.SSH.ClientKeyApi do
  ...
  `
  cb = SSHKit.SSH.ClientKeyApi.with_config(identity: "path/to/keyfile", known_hostss: "path_to_known_hostsFile", accept_hosts: false)  
  `
...
### Example
  ...
  defp accept_hosts(opts) do    
    IO.inspect(cb_opts(opts)[:accept_hosts])
